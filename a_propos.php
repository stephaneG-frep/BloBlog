...
<div class="container col-xxl-8 px-4 py-5 text-center">
     ...
     <div class="container px-5">
        <img src="assets/images/hack.jpg" class="img-fluid" alt="photo de nos bureaux" width="1000" height="400" loading="lazy">
      </div>
    ...
    <div class="col-lg-6 mx-auto">
      ...
      <a class="text-decoration-none fw-bold" href="mailto:weshsteff@yahoo.fr?sujet=toutes vos questions"><strong >Email</strong> : </a>
       Nous avons crée cette appli web pour vous aider dans vos enchages quotidienne familliaux ou/et de travail. </br> Elle reste et restera gratuite.
      </p>    
    </div>
    <div class="row">
      <div class="container px-5">
        <img src="assets/images/bureau2.jpg" class="img-fluid" alt="photo de nos bureaux" width="1000" height="400" loading="lazy">
      </div>
    </div>
</div>
